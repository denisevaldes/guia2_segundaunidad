...
class text_view(Gtk.Dialog):
    def __init__(self):
        ...
        self.grid.attach(self.button1,0,5,3,1)
    ...
    def mensaje_textview(self, contenido):
        #se le entrega un texto a text_view
        self.textbuffer.set_text(contenido)
        self.texto = self.textbuffer.props.textS

    def boton_guardar(self, btn = None):
        #creacion de ventana de tipo filechooser para guardar archivo
    ...
    def abrir_archivo(self, btn = None):
        ##creacion de ventana de tipo filechooser para abrir archivo
